...
public static class DogBreedsSeed
{
	private static readonly List<BreedEntity> Breeds = new()
	{
		...
		new()
		{
			...
			Group = 2,
			Section = 1,
			//Varieties = new List<BreedVarietyEntity>
			//{
			//	new()
			//	{
			//	Name = "pepper and salt" //FCI: all judged separately
		 //       },
			//	new()
			//	{
			//		Name = "pure black with black undercoat"
		 //       },
			//	new()
			//	{
		...
		new()
		{
			...
			//	new()
			//	{
			//		Name = "pure white with white undercoat"
			//	}
			//}
		},
		new()
		...
		new()
		{
			...
			//	new()
			//	{
			//		Name = "fawn" //FCI: judged with brindle
			//	},
			//	new()
			//	{
			//		Name = "brindle" 
			...
			//	new()
			//	{
			//		Name = "black" //FCI: judged with harlequin
			//	},
			//	new()
			//	{
			//		Name = "harlequin"
